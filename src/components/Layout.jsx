          ...
          <div className="flex items-center justify-between h-12 sm:h-14 text-sm sm:text-base" style={{ fontFamily: "'Playfair Display', Georgia, serif" }}>
            ...
            <div className="flex items-center gap-3">
              <div className="flex items-center gap-2">
                <a href="#" className="w-8 h-8 rounded-full bg-white/15 flex items-center justify-center text-white/80 hover:bg-gradient-to-br hover:from-brand-teal hover:to-brand-navy hover:text-white hover:shadow-lg hover:shadow-brand-teal/30 transition-all duration-300">
