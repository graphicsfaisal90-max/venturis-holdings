    ...
    <footer className="bg-brand-dark text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <div className="mb-4">
              <img src="/logo.png" alt="Venturis Holdings LLC" className="h-12 w-auto brightness-0 invert" />
            </div>
              ...
              <li className="flex items-start gap-2">
                ...
                <div className="space-y-1">
                  <a href="tel:+971585318860" className="block hover:text-white transition-colors">+971 58 531 8860</a>
                   <a href="tel:+19046550900" className="block hover:text-white transition-colors">+1 (904) 6550900</a>
                </div>
              </li>
              <li className="flex items-start gap-2">
                <svg className="w-4 h-4 mt-1 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div>
                  <span className="text-white/60 text-xs block mb-2">Follow Us</span>
                  <div className="flex items-center gap-2">
                    <a href="javascript:void(0)" rel="nofollow noopener noreferrer" className="w-8 h-8 rounded-lg bg-white/10 flex items-center justify-center text-brand-light hover:bg-gradient-to-br hover:from-brand-teal hover:to-brand-navy hover:text-white transition-all duration-300">
        ...
        <div className="border-t border-brand-navy/50 mt-8 pt-8 text-center text-brand-muted text-sm">
          &copy; {new Date().getFullYear()} Venturis Holdings LLC. All rights reserved.
        </div>
      </div>
    </footer>
  )
