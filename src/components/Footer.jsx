              ...
              <li className="flex items-start gap-2">
                ...
                <div>
                  ...
                  <div className="flex items-center gap-2">
                    <a href="#" className="w-8 h-8 rounded-lg bg-white/10 flex items-center justify-center text-brand-light hover:bg-gradient-to-br hover:from-brand-teal hover:to-brand-navy hover:text-white transition-all duration-300">
