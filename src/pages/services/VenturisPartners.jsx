    ...
    <>
      <section className="bg-gradient-to-br from-brand-from to-brand-to text-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl sm:text-5xl font-bold mb-4">Venturis Partners</h1>
          <p className="text-xl text-white/70 max-w-2xl">Empowering businesses through collaborative partnerships and innovative corporate solutions that drive long-term success.</p>
        </div>
      </section>
