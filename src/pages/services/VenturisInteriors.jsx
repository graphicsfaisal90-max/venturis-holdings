...
const projects = [
  ...
  {
    title: 'Reflective Elegance Foyer',
    category: 'Residential',
    image: '/project-3.png',
  },
  {
    title: 'Serene Minimalist Living Room',
    category: 'Residential',
    image: '/project-4.png',
  },
  {
              ...
              >
                <div className="relative h-56 sm:h-64 overflow-hidden rounded-t-2xl">
                  <img
                    src={s.image}
                    alt={s.title}
                    className="w-full h-full object-[center_25%] object-cover transition-all duration-700 ease-out group-hover:scale-110 group-hover:rotate-[2deg] group-focus-within:scale-110 group-focus-within:rotate-[2deg]"
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-brand-dark/60 to-transparent opacity-60 group-hover:opacity-90 group-focus-within:opacity-90 transition-opacity duration-500" />
                  <div className="absolute inset-0 bg-gradient-to-br from-brand-teal/20 to-transparent opacity-0 group-hover:opacity-100 group-focus-within:opacity-100 transition-opacity duration-500" />
                  <div className="absolute bottom-0 left-0 right-0 p-6 translate-y-3 group-hover:translate-y-0 group-focus-within:translate-y-0 transition-transform duration-500">
