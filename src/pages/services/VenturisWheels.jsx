        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <AnimatedSection>
              ...
              <div className="mt-6 p-4 bg-brand-light rounded-xl border border-brand-teal/10">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <span className="text-sm font-bold text-brand-dark">Imports of cars from </span>
                    <span className="text-sm font-bold text-brand-teal">USA, CANADA &amp; JAPAN</span>
                  </div>
                </div>
              </div>
            </AnimatedSection>
