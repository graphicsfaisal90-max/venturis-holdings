        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <AnimatedSection className="mb-12 sm:mb-16 md:mb-24">
            <div className="text-center mb-8 sm:mb-12">
              ...
              <h3 className="text-2xl sm:text-3xl md:text-4xl font-bold text-brand-dark mb-3 sm:mb-4">The G-Class Lineup</h3>
            ...
            <div className="grid sm:grid-cols-3 gap-4 sm:gap-6">
              <div className="group bg-gray-50 rounded-2xl overflow-hidden border border-gray-100 hover:shadow-lg hover:shadow-brand-teal/10 hover:border-brand-teal/20 transition-all duration-500">
                ...
                <div className="p-5 sm:p-6">
                  ...
                  <h4 className="text-lg sm:text-xl font-bold text-brand-dark">G 500</h4>
                  <p className="text-gray-400 text-xs sm:text-sm mt-1">From AED 759,900</p>
              ...
              <div className="group bg-gray-50 rounded-2xl overflow-hidden border border-gray-100 hover:shadow-lg hover:shadow-brand-teal/10 hover:border-brand-teal/20 transition-all duration-500">
                ...
                <div className="p-5 sm:p-6">
                  ...
                  <h4 className="text-lg sm:text-xl font-bold text-brand-dark">Mercedes-AMG G 63</h4>
                  <p className="text-gray-400 text-xs sm:text-sm mt-1">From AED 1,049,900</p>
                  <div className="mt-3 flex items-center gap-2 text-gray-400 text-xs">
              ...
              <div className="group bg-gray-50 rounded-2xl overflow-hidden border border-gray-100 hover:shadow-lg hover:shadow-brand-teal/10 hover:border-brand-teal/20 transition-all duration-500">
                ...
                <div className="p-5 sm:p-6">
                  ...
                  <h4 className="text-lg sm:text-xl font-bold text-brand-dark">G 580 with EQ</h4>
                  <p className="text-gray-400 text-xs sm:text-sm mt-1">From AED 825,900</p>
                  <div className="mt-3 flex items-center gap-2 text-gray-400 text-xs">
                    <span>Electric</span>
                    <span className="w-1 h-1 rounded-full bg-gray-300" />
                    <span>587 PS</span>
          ...
          <AnimatedSection className="mb-12 sm:mb-16 md:mb-24">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div>
                ...
                <h3 className="text-2xl sm:text-3xl font-bold text-brand-dark mb-6">Born in 1979. An everlasting classic.</h3>
                <p className="text-gray-500 leading-relaxed mb-6 text-sm sm:text-base">
                ...
                <div className="grid grid-cols-3 gap-4">
                  <div className="bg-gray-50 rounded-xl p-4 text-center border border-gray-100">
                    <div className="text-2xl font-bold text-brand-dark font-number">1979</div>
                    <div className="text-gray-400 text-xs mt-1">Birth</div>
                  </div>
                  <div className="bg-gray-50 rounded-xl p-4 text-center border border-gray-100">
                    <div className="text-2xl font-bold text-brand-dark font-number">45+</div>
                    <div className="text-gray-400 text-xs mt-1">Years</div>
                  </div>
                  <div className="bg-gray-50 rounded-xl p-4 text-center border border-gray-100">
                    <div className="text-2xl font-bold text-brand-dark font-number">500k+</div>
                    <div className="text-gray-400 text-xs mt-1">Built</div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <AnimatedSection className="mb-12 sm:mb-16 md:mb-24">
            <div className="text-center mb-8 sm:mb-12">
              ...
              <h3 className="text-2xl sm:text-3xl md:text-4xl font-bold text-brand-dark mb-3 sm:mb-4">A timeless icon in automotive design</h3>
              <p className="text-gray-500 max-w-2xl mx-auto text-sm sm:text-base">
          ...
          <AnimatedSection className="mb-12 sm:mb-16 md:mb-20">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div className="relative order-2 lg:order-1">
                ...
                <h3 className="text-2xl sm:text-3xl font-bold text-brand-dark mb-6">Individuality in its most beautiful form</h3>
                <p className="text-gray-500 leading-relaxed mb-6 text-sm sm:text-base">
                ...
                <div className="space-y-3">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-gray-600 text-sm">28+ MANUFAKTUR exterior colours</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <div className="w-8 h-8 rounded-full bg-brand-light flex items-center justify-center shrink-0">
                      <svg className="w-4 h-4 text-brand-teal" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <span className="text-gray-600 text-sm">Full Nappa leather interior packages</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <div className="w-8 h-8 rounded-full bg-brand-light flex items-center justify-center shrink-0">
                      <svg className="w-4 h-4 text-brand-teal" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <span className="text-gray-600 text-sm">Schöckl Design Package & Logo Package</span>
                  </div>
                </div>
              </div>
          ...
          <AnimatedSection className="mb-12 sm:mb-16 md:mb-20">
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 sm:gap-6">
              <div className="bg-gray-50 rounded-2xl p-6 sm:p-8 text-center border border-gray-100">
                <div className="text-2xl sm:text-3xl font-bold text-brand-dark font-number">585</div>
                <div className="text-brand-teal text-xs uppercase tracking-widest font-medium mt-1">PS Power</div>
                <p className="text-gray-400 text-xs mt-1">AMG G 63</p>
              </div>
              <div className="bg-gray-50 rounded-2xl p-6 sm:p-8 text-center border border-gray-100">
                <div className="text-2xl sm:text-3xl font-bold text-brand-dark font-number">4.5s</div>
                <div className="text-brand-teal text-xs uppercase tracking-widest font-medium mt-1">0-100 km/h</div>
                <p className="text-gray-400 text-xs mt-1">AMG G 63</p>
              </div>
              <div className="bg-gray-50 rounded-2xl p-6 sm:p-8 text-center border border-gray-100">
                <div className="text-2xl sm:text-3xl font-bold text-brand-dark font-number">850</div>
                <div className="text-brand-teal text-xs uppercase tracking-widest font-medium mt-1">Nm Torque</div>
                <p className="text-gray-400 text-xs mt-1">AMG G 63</p>
              </div>
              <div className="bg-gray-50 rounded-2xl p-6 sm:p-8 text-center border border-gray-100">
                <div className="text-2xl sm:text-3xl font-bold text-brand-dark font-number">220</div>
                <div className="text-brand-teal text-xs uppercase tracking-widest font-medium mt-1">km/h</div>
                <p className="text-gray-400 text-xs mt-1">Top Speed</p>
              </div>
            </div>
          </AnimatedSection>
