...
const realEstateServices = [
  ...
  {
    title: 'Property Consultancy & Legal Compliance',
    desc: 'End-to-end property advisory and legal compliance solutions ensuring seamless transactions, regulatory adherence, and risk-free documentation across UAE markets.',
    icon: (
      <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
